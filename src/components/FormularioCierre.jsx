...
function CampoInfo({ label, valor, mono = false }) {
  return (
    <div>
        ...
        <>
          <Card shadow="sm">
            <CardHeader className="flex justify-between pb-0">
              ...
              <Chip size="sm" variant="flat" color={chipColor(tareaSeleccionada.id_atm)}
                className="font-mono">{tareaSeleccionada.id_atm}</Chip>
            </CardHeader>
            <Divider className="mt-3" />
            <CardBody>
              <div className="grid grid-cols-2 gap-4 mb-4">
                <CampoInfo label="WO"     valor={tareaSeleccionada.wo}     mono />
                <CampoInfo label="Modelo" valor={tareaSeleccionada.modelo} mono />
                <CampoInfo label="Serie"  valor={tareaSeleccionada.serie}  mono />
